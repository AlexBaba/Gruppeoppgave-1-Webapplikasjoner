namespace Nettbutikk.Migrations
{
    ...
    internal class DbSeed
    {
        ...
        private const string adminLastName = "User";
        private const string adminUserPassword = "password";
        private const string adminUserName = "root";
        private const string adminUserEmail = "root@example.com";

        private User adminUser = null;

        private NettbutikkContext db;
        ...
        {
            get {
                return adminUser ?? (adminUser = new User()
                {
                    Id = adminUserName,
                    ...
                    PasswordHash = new PasswordHasher().HashPassword(adminUserPassword),
                    EmailConfirmed = true,
                });
            }
        }

        private DbSeed(NettbutikkContext context)
        {
            db = context;
        ...
        public static void Seed(NettbutikkContext db)
        {
            new DbSeed(db).Seed();
        }
        ...
        public void Seed()
        {
            if(db.Users.Count() < 1 || !db.Users.Any(user => adminUserName == user.UserName))
                if(!createAdminUser())
        ...
        {
            //var bilder = new List<Image> {
            //    ,

            //    new Image() { Product = 2, Path = "/Images/LightTankMkVI.png" },

            //    new Image() { Product = 3, Path = "/Images/M4Sherman.png" },

            //    new Image() { Product = 4, Path = "/Images/M10tankdestroyer.png" },

            //    new Image() { Product = 5, Path = "/Images/M26Pershing.png" },

            //    new Image() { Product = 6, Path = "/Images/Tiger1.png" },

            //    new Image() { Product = 7, Path = "/Images/ShermanFirefly.png" },

            //    new Image() { Product = 8, Path = "/Images/Panther.png" },

            //    new Image() { Product = 9, Path = "/Images/T54.png" },

            //    new Image() { Product = 10, Path = "/Images/Centuriontank.png" },

            //    new Image() { Product = 11, Path = "/Images/Zulfiqar.png" },

            //    new Image() { Product = 12, Path = "/Images/Stridsvagn122.png" },

            //    new Image() { Product = 13, Path = "/Images/T72m4cz.png" },

            //    new Image() { Product = 14, Path = "/Images/T-90SM.png" },

            //    new Image() { Product = 15, Path = "/Images/tanks1.jpg" },

            //    new Image() { Product = 16, Path = "/Images/tanks1.jpg" },

            //    new Image() { Product = 17, Path = "/Images/tanks1.jpg" }
            //};
        }
        ...
        private bool createAdminUser()
        {
            ...
            return createUser(AdminUser, adminRoleName);
        }
        
        private bool createUser(User user, params string[] roleNames)
        {
        ...
        {
            return (null == roleManager.FindByName(roleName)) || roleManager.Create(new IdentityRole(roleName)).Succeeded;
        }
    }
}
