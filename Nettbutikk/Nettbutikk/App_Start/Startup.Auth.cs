...
namespace Nettbutikk
{
    public partial class Startup
    {
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            // verification factor such as phone or email. Once you check this
            // option, your second step of verification during the login
            // process will be remembered on the device where you logged in
            // from. This is similar to the RememberMe option when you log in.
